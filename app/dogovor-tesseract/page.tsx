      ...
      <div className="relative mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16">
        <section className="mb-8 rounded-3xl border border-slate-200/90 bg-white p-6 shadow-md shadow-slate-900/5 sm:p-9">
          <h1 className="mb-2 text-xl font-semibold tracking-tight text-black">
            Договор по 3 документам (Tesseract)
          </h1>
          <p className="mb-6 text-sm text-slate-600">
            Распознавание без Hugging Face: на сервере только Tesseract и правила разбора. Тот же
            сценарий, что и на главной, но дальше —{" "}
            <code className="rounded bg-slate-100 px-1 py-0.5 text-xs">unified-json-to-contract</code>{" "}
            из dogovor_new.
          </p>
            ...
            <section className="mb-8 rounded-3xl border border-slate-200/90 bg-white p-6 shadow-md shadow-slate-900/5 sm:p-8">
              <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
                <h2 className="text-xl font-semibold tracking-tight text-black">
                  Результат (model: tesseract+rules)
                </h2>
              </div>
